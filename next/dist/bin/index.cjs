...
var copyFile = (baseDir, fileName) => {
  const destPath = import_path.default.join(baseDir, fileName);
  const sourceFilePath = import_path.default.join(baseDir, "node_modules", "websites-factory", "dist", fileName);
